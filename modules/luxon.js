    ...
    let r = "basic" === e.format ? "hhmm" : "hh:mm",
      n =
        ((e.suppressSeconds && 0 === t.seconds && 0 === t.milliseconds) ||
          ...
          e.suppressMilliseconds && 0 === t.milliseconds) ||
          (r += ".SSS"),
        t.toFormat(r));
...
class x {
  ...
  static fromDateTimes(e, t) {
    var e = kn(e),
      t = kn(t),
      r = Or(e, t);
    return null == r ? new x({ start: e, end: t }) : r;
  }
  static after(e, t) {
        ...
        (function (t) {
          ...
          if (isNaN(r)) {
            ...
            for (let e = 0; e < t.length; e++) {
              ...
              if (-1 !== t[e].search(Mr.hanidec)) r += Er.indexOf(t[e]);
              else
                for (const a in Dr) {
                  var [s, i] = Dr[a];
                  s <= n && n <= i && (r += n - s);
  ...
  return Array.prototype.concat(
    ...e.map((e) => {
      return (
        (t = r),
        (e = e).literal ||
        null == (t = Ur(T.macroTokenToFormatOpts(e.val), t)) ||
        t.includes(void 0)
          ? e
          : t
      );
...
function _r(e, t, r) {
  var { result: e, zone: t, specificOffset: r, invalidReason: n } = jr(e, t, r);
  return [e, t, r, n];
}
function Ur(i, e) {
  return i
        ...
        .map((t) => {
          {
            var r = i,
              { type: t, value: n } = t;
            if ("literal" === t)
              return { literal: !(s = /^\s+$/.test(n)), val: s ? " " : n };
            var s = r[t];
            let e = zr[t];
            return (e = "object" == typeof e ? e[s] : e)
              ? { literal: !1, val: e }
              : void 0;
          }
        })
...
class L {
  ...
  minus(e) {
    return this.isValid
      ? sn(this, ln(this, V.fromDurationLike(e).negate()))
      : this;
  }
  startOf(e) {
    if (!this.isValid) return this;
  ...
  toISO({
    ...
    var i;
    return this.isValid
      ? ((i = dn(this, (e = "extended" === e))),
        (i += "T") + mn(this, e, t, r, n, s))
      : null;
  }
  toISODate({ format: e = "extended" } = {}) {
    return this.isValid ? dn(this, "extended" === e) : null;
  }
  toISOWeekDate() {
  ...
  toISOTime({
    ...
    return this.isValid
      ? (n ? "T" : "") + mn(this, "extended" === i, t, e, r, s)
      : null;
  }
  toRFC2822() {
  ...
  toRelative(e = {}) {
    ...
    return (
      ...
      On(t, this.plus(r), { ...e, numeric: "always", units: n, unit: s })
    );
  }
